...
for i in 1 1.58 2 4 8 11.8 16 32 40; do cat subsample_$i/tables/CO_NCO_table_* > subsample_$i/tables/CO_NCO_${i}_table.txt; done
	
for i in 1 1.58 2 4 8 11.8 16 32 40; do for j in `seq 1 20`; do echo $i; done > tmp.txt; paste tmp.txt subsample_$i/tables/CO_NCO_${i}_table.txt; done > CO_NCO_table_all.txt
